            ...
            <nav className="navbar_event_conference">
                ...
                <div className="left_navbar">
                    <div className="nav_links">
                        <a href="#home" className="home_button" onClick={(e) => { e.preventDefault(); navigateToProducts("#home"); }}>Home</a>
                        <a href="#venue" onClick={(e) => { e.preventDefault(); navigateToProducts("#venue"); }}>Venue</a>
                        <a href="#addons" onClick={(e) => { e.preventDefault(); navigateToProducts("#addons"); }}>Add-ons</a>
                        <a href="#meals" onClick={(e) => { e.preventDefault(); navigateToProducts("#meals"); }}>Meals</a>
            ...
            <div className="main_container" id="home">
                {!showItems ? (
                    ...
                    <div className="total_amount_detail">
                        <TotalCost totalCosts={totalCosts} ItemsDisplay={() => <ItemsDisplay items={items} />} currencySymbol="₹" />
                    </div>
                )}
            </div>
        </>
